...
describe FamiliesController, type: :controller do
  before do
    ...
    @bride = FactoryGirl.create(:person, gender: 'Female')
  end
  ...
  it 'should create a new family' do
    ...
    post :create,
         { family: { name: name, last_name: last_name, address1: '123 S Morgan st.', address2: '', city: 'Tulsa',
                     state: 'OK', zip: '74120', home_phone: '123-456-7890' } }, logged_in_id: @admin.id
  ...
  it 'should not create a new family unless user is admin' do
    ...
    post :create,
         { family: { name: name, last_name: last_name, address1: '123 S Morgan st.', address2: '', city: 'Tulsa',
                     state: 'OK', zip: '74120', home_phone: '123-456-7890' } }, logged_in_id: @person.id
    expect(response).to be_forbidden
  end
  ...
  it 'should edit a family' do
    ...
    expect(response).to be_success
    post :update,
         { id: @family.id, family: { name: @family.name, last_name: @family.last_name, address1: @family.address1,
                                     address2: @family.address2, city: @family.city, state: @family.state,
                                     zip: @family.zip, home_phone: @family.home_phone } }, logged_in_id: @admin.id
    expect(response).to be_redirect
  end

  it 'should not show xml unless user can export data' do
    expect { get :show, { id: @family.id, format: 'xml' }, logged_in_id: @person.id }
  ...
  pending 'should send a join request for newlyweds' do
    post :join, { id: @family.id }, logged_in_id: @bride.id
  end
end
